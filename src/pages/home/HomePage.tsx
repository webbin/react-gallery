  ...
  return (
    ...
    >
      <div className={styles.home_text_content}>
        ...
        <p>
          <a href="https://redux-toolkit.js.org">Redux Toolkit</a> is our
          official standard approach for writing Redux logic. It wraps around
          the Redux core, and contains packages and functions that we think are
          essential for building a Redux app. Redux Toolkit builds in our
